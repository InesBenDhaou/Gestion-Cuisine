...
public class FrameIng extends JFrame {
    ...
    {    
        ...
        table = new JLabel("-Table Ingredient-");
        table.setFont(new Font(Font.SERIF, Font.BOLD, 30));
        table.setForeground(Color.black);
        table.setBounds(70, 130, 400,100);

        

        // traitement input
        Ref = new JLabel("RefIngredient : ");
        ...
        Nom = new JLabel("NomIngredient :");
        Nom.setFont(new Font(Font.SERIF, Font.BOLD, 20));
        Nom.setForeground(Color.black);
        Nom.setBounds(30, 250, 400,100);
        ...
        RefType = new JLabel("RefType :");
        RefType.setFont(new Font(Font.SERIF, Font.BOLD, 20));
        RefType.setForeground(Color.black);
        RefType.setBounds(30, 300, 400,100);
        
        inputRefType = new JTextField();
        inputRefType.setPreferredSize(new Dimension(200, 10));
        inputRefType.setBounds(180, 340, 200,30);
        inputRefType.setBackground(Color.white);
        inputRefType.setFont(new Font(Font.SERIF, Font.BOLD, 16));
        inputRefType.setForeground(Color.GRAY);
        inputRefType.setText("Entrer la ReferenceType ");
        inputRefType.addFocusListener(new FocusListener() {
            public void focusGained(FocusEvent e) {
                if (inputRefType.getForeground() == Color.GRAY) {
                    inputRefType.setText("");
                    inputRefType.setForeground(Color.black);
                }
            }
            
            public void focusLost(FocusEvent e) {
                if (inputRefType.getText().isEmpty()) {
                    inputRefType.setText("Entrer la ReferenceType");
                    inputRefType.setForeground(Color.black);
                }
            }
        });
        inputRefType.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                inputRefType.setBackground(new Color (248, 160, 160));
                }
            ...
            if (Action.equals("insertion")){
                    ...
                    inserer.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {  
                            ...
                            RefTypeValue = inputRefType.getText();
                            TypeIngredientDao t = new TypeIngredientDao(con);
                            Ingridient ti = new Ingridient(Refvalue, Nomvalue , t.find(RefTypeValue));
                            IngredientDao tid = new IngredientDao (con);   
                            tid.create(ti);
        ...
        if (Action.equals("Modification") || Action.equals("insertion") )
        {
            ...
            backgroundImage.add(RefType);
            backgroundImage.add(inputRefType);
        }
