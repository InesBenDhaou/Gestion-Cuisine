...
public class FrameRangement extends JFrame {
    ...
    public FrameRangement (String Action)
    {    
        ...
        table = new JLabel("-Table Rangement-");
         ...
         if (Action.equals("insertion")){
                ...
                inserer.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {  
                        ...
                        Rangement ti = new Rangement(Nomvalue, Refvalue);
                        RangementDao tid = new RangementDao (con);   
                        tid.create(ti);
